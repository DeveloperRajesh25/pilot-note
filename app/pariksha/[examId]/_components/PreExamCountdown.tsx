...
export function PreExamCountdown({ examId, exam, startAt, endAt, serverNowMs, onPhaseChange }: Props) {
  ...
  return (
    <main className="grow pt-32 pb-24 bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-5xl md:text-7xl leading-[0.95] tracking-[-0.03em] text-neutral-900 mb-6">
            {exam.title}
          </h1>
          ...
          <div className="border border-neutral-200 rounded-3xl p-8 md:p-12 bg-white">
            <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.22em] text-neutral-500 font-medium mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 border-t border-neutral-200 pt-8">
          ...
          <div className="mt-10 border border-neutral-200 rounded-3xl p-8 bg-neutral-50">
            <h3 className="font-display text-xl text-neutral-900 mb-3">Before you begin</h3>
            <ul className="space-y-2 text-sm text-neutral-700 leading-relaxed list-disc pl-5">
              ...
              <li>The exam runs in fullscreen. Leaving fullscreen, switching tabs, or copying content is logged and visible to administrators.</li>
...
function TimeUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="text-center">
      <p className="font-display text-5xl md:text-6xl text-neutral-900 leading-none tracking-tight tabular-nums">
        {value.toString().padStart(2, '0')}
      </p>
      <p className="text-[10px] uppercase tracking-[0.22em] text-neutral-400 mt-3 font-medium">{label}</p>
    </div>
  );
}
