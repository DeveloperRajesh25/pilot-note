  ...
  return (
    <>
      ...
      <main className="grow bg-white">
        ...
        <section className="relative pt-36 pb-24 overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative">
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-[clamp(2.5rem,5.5vw,4.5rem)] leading-[1.05] tracking-[-0.03em] text-neutral-900 mb-6">
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-4">
                ...
                <h2 className="font-display text-4xl md:text-5xl text-neutral-900 leading-[1.05] tracking-tight">
                  Make pilot training in India <span className="italic-serif">accessible</span>, honest, and high quality.
                </h2>
              </div>
              <div className="lg:col-span-7 lg:col-start-6 space-y-5 text-neutral-600 text-[15px] leading-relaxed">
                <p>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {PILLARS.map((p) => (
                ...
                >
                  <div className="w-11 h-11 rounded-2xl bg-neutral-900 text-white flex items-center justify-center mb-5 group-hover:bg-emerald-500 transition-colors">
                    {p.icon}
                  </div>
                  <h3 className="font-display text-xl text-neutral-900 mb-2.5">{p.title}</h3>
        ...
        <section className="py-20 border-t border-neutral-200">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-200 border border-neutral-200 rounded-3xl overflow-hidden">
              {STATS.map((s) => (
                <div key={s.label} className="bg-white p-8 lg:p-10 flex flex-col gap-2">
                  <p className="font-display text-4xl md:text-5xl text-neutral-900 tracking-tight">
                    {s.value}
                  </p>
                  <p className="text-[11px] uppercase tracking-[0.22em] text-neutral-500 font-medium">
                    {s.label}
                  </p>
                </div>
              ))}
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {VALUES.map((v) => (
                <div key={v.title} className="flex gap-5">
                  ...
                  <div>
                    <h3 className="font-display text-xl text-neutral-900 mb-2">{v.title}</h3>
                    <p className="text-neutral-600 text-[15px] leading-relaxed">{v.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-24 border-t border-neutral-200 bg-neutral-50">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-display text-4xl md:text-5xl text-neutral-900 leading-[1.05] tracking-tight mb-5">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3">
                ...
                <Link
                  href="/contact"
                  className="group inline-flex items-center gap-1.5 text-sm font-medium text-neutral-700 hover:text-neutral-900 px-4 py-3"
                >
                  Talk to us
                  <ArrowUpRight
                    size={14}
